...
//Chaining multiple middlware on pre save hook
// tourSchema.pre('save', function(next) {
...
tourSchema.pre(/^find/, function(next) {
  // all the query events that start with 'find'
  // tourSchema.pre(/\b(find|findOne)\b/, function(next) {
  // tourSchema.pre('find', function(next) {
