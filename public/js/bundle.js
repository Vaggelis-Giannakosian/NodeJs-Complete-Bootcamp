...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibG9zdHJlIiwiYSI6ImNrM2toNjAyeTAzMDczbXQ1anAwYzU5MmgifQ.lWYGAi2owqwh5d3Q1Fiofw';
...
if (updatePassword) {
  updatePassword.addEventListener('submit', function _callee(e) {
...
if (bookTourBtn) {
  bookTourBtn.addEventListener('click', function _callee2(e) {
    var tourId;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return regeneratorRuntime.awrap((0, _stripe.bookTour)(tourId));
